...
Running `src/backtest.py` regenerates the equity curve (`plots/pnl_curve.html`) and per-market P&L distribution (`plots/pnl_hist.html`).
...
plots/   interactive Plotly outputs (regenerated by the scripts, not committed)
```
